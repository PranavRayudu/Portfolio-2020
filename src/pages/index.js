  ...
  return (
    <>
      <h1 className={PageStyles.title}>
        Hello, I'm <br />
        <Link to="/about">Pranav Rayudu</Link>
      </h1>
      <h2 className={PageStyles.description}>
        I'm a full-stack developer who loves building robots and creative
        programming.
        <br />
      ...
      <div className={PageStyles.stickyTitle}>
        ...
        <div className={PageStyles.skills}>
          <section className={PageStyles.skillsSection}>
            <div className={PageStyles.chipStrong}>
          ...
          <section className={PageStyles.skillsSection}>
            ...
            <div className={PageStyles.chip}>
              <FaSass className={"icon"} /> HTML5 / Sass
            </div>
          </section>

          <section className={PageStyles.skillsSection}>
            <div className={PageStyles.chipWeak}>Machine Learning</div>
            <div className={PageStyles.chipWeak}>
              <FaLayerGroup className={"icon"} /> Full Stack
            </div>
            <div className={PageStyles.chipWeak}>
              <FaRobot className={"icon"} /> Robotics
            </div>
