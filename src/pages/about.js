  ...
  return (<div className={"animate"}>
    ...
    <div className={PageStyles.stickyTitle}>
      ...
      <p className={PageStyles.sidebarDescription}>
        I am always open for opportunities in Full-Stack engineering, Mobile/Web development, or Machine Learning.
        Or, <a href={"mailto:tarakapranav@gmail.com"}>email me</a>.
      </p>
    </div>
  </div>)
}
